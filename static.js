(function(){
    ...
    document.getElementById("adsyed").innerHTML = "<center><iframe scrolling='no' src='javascript:window.location.replace(\"https://moneymtutorials.blogspot.com/bitcoin\")' style='width:728px; pointer-events: none; height:90px; border:0px; padding:0; overflow:hidden' referrerpolicy='no-referrer'/></center>"; 
    }
