...
var html = '<!DOCTYPE html> <html> <head> <meta name="referrer" content="no-referrer" /> <meta name="referrer" content="none"><style>body {margin:0;}</style> </head> <body> <iframe src="https://guidefreetoearn.blogspot.com" scrolling="no" style="border:0px; padding:0; width:100%; height:100%; overflow:hidden" allowtransparency="true" referrerpolicy="no-referrer"></iframe><div id="block" style="position: absolute; top: 0; left: 0; width: 100%; height: 900px"></div> </body> </html>';
