...
async function relCall() {
        ...
        if(document.getElementById("top_720")){
            ...
            var script = document.createElement('script');
            script.type = 'text/javascript';
            script.src = 'https://www.highperformancedformats.com/9517a4efa0af3fead641c773740cb25f/invoke.js';
            var el = document.getElementById("top_720");
            el.appendChild(script);
        }
        await sleep(3000);
        if(document.getElementById("sidebar_300")){
            ...
            var script = document.createElement('script');
            script.type = 'text/javascript';
            script.src = 'https://www.highperformancedformats.com/90073778d39cc0a40947c56562a933d5/invoke.js';
            var el = document.getElementById("sidebar_300");
            el.appendChild(script);
        }
        await sleep(3000);
        if(document.getElementById("in_post_bottomads")){
            ...
            var script = document.createElement('script');
            script.type = 'text/javascript';
            script.src = 'https://www.highperformancedformats.com/3a70c20c4dd4363472d820cab195c162/invoke.js';
            var el = document.getElementById("a458d2acc");
            el.appendChild(script);
        }
}
